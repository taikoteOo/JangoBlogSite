...
from django.conf.global_settings import MEDIA_ROOT, LOGIN_REDIRECT_URL, LOGIN_URL
...
SECRET_KEY = 'django-insecure-d5nt#3@c=%m%8jg%)pf@auo3li+3o_($#d(^c#g9fz1bnoxn*m'
